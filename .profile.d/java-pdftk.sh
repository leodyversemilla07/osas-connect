...
# Create empty security properties file to bypass Java security initialization
echo "# Empty security properties" > /tmp/java.security.empty

# Set Java headless mode and disable security system to prevent configuration issues
export JAVA_OPTS="-Djava.awt.headless=true \
                  -Djava.security.manager= \
                  -Djava.security.properties=/tmp/java.security.empty \
