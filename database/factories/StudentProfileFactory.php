...
class StudentProfileFactory extends Factory
{
    public function definition(): array
    {
        ...
        return [
            ...
            'income_from_business' => fake()->optional(0.3)->randomFloat(2, 50000, 500000),
            'income_from_land_rentals' => fake()->optional(0.2)->randomFloat(2, 24000, 240000),
            'income_from_building_rentals' => fake()->optional(0.2)->randomFloat(2, 60000, 600000),
            'retirement_benefits_pension' => fake()->optional(0.1)->randomFloat(2, 60000, 300000),
            'commissions' => fake()->optional(0.3)->randomFloat(2, 12000, 120000),
            'support_from_relatives' => fake()->optional(0.4)->randomFloat(2, 12000, 120000),
            'bank_deposits' => fake()->optional(0.3)->randomFloat(2, 10000, 100000),
            'other_income_description' => fake()->optional(0.2)->sentence(),
            'other_income_amount' => fake()->optional(0.2)->randomFloat(2, 12000, 120000),
            ...
            // Monthly Expenses
            'house_rental' => fake()->optional(0.4)->randomFloat(2, 3000, 15000),
            ...
            'school_bus_payment' => fake()->optional(0.3)->randomFloat(2, 1000, 5000),
            'transportation_expense' => fake()->randomFloat(2, 1000, 8000),
            'education_plan_premiums' => fake()->optional(0.3)->randomFloat(2, 2000, 10000),
            'insurance_policy_premiums' => fake()->optional(0.4)->randomFloat(2, 2000, 8000),
            'health_insurance_premium' => fake()->optional(0.4)->randomFloat(2, 2000, 8000),
            'sss_gsis_pagibig_loans' => fake()->optional(0.3)->randomFloat(2, 1000, 5000),
            ...
            'medicine_expense' => fake()->optional(0.4)->randomFloat(2, 500, 5000),
            'doctor_expense' => fake()->optional(0.3)->randomFloat(2, 500, 5000),
            'hospital_expense' => fake()->optional(0.2)->randomFloat(2, 1000, 10000),
            ...
            'withholding_tax' => fake()->optional(0.4)->randomFloat(2, 12000, 120000),
