...
import { ArrowUpDown, MoreHorizontal, Eye, Users, FileText } from "lucide-react"
...
export const columns: ColumnDef<Application>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <Badge className={statusColors[status as keyof typeof statusColors] || statusColors.submitted}>
