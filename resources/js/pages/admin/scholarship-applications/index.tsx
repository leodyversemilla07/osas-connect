            ...
            <div className="flex h-full flex-1 flex-col space-y-6 p-6">
                ...
                <div className="mb-4 flex items-center justify-between">
                    <div>
                        ...
                        <div className="text-muted-foreground mt-2 text-base">Review and manage all scholarship applications</div>
                    </div>
                    <div className="flex gap-3">
                        <Button variant="outline" onClick={() => router.visit('/admin/scholarships')}>
                        ...
                        <Pagination className="py-4">
                            ...
                            <PaginationContent>
                                ...
                                {[...Array(applications.last_page)].map((_, i) => {
                                    ...
                                    const showPage =
                                        pageNum === 1 || pageNum === applications.last_page || Math.abs(pageNum - applications.current_page) <= 2;
                                    if (!showPage) {
