...
import { Award, Calendar, Eye, Plus, Search } from 'lucide-react';
                                    ...
                                    <TableRow key={scholarship.id} className="hover:bg-muted/30 transition-colors">
                                        <TableCell className="font-medium">
                                            <div className="space-y-1">
                                                <div className="text-foreground font-semibold">{scholarship.name}</div>
                                                <div className="text-muted-foreground line-clamp-1 text-sm">{scholarship.description}</div>
                                            </div>
                                        </TableCell>
                                        <TableCell>
                                ...
                                <TableRow>
                                    <TableCell colSpan={6} className="h-32 text-center">
                                        <div className="flex flex-col items-center gap-2">
                                            ...
                                            <div className="text-muted-foreground text-xs">Try adjusting your search or filter criteria</div>
                                        </div>
                                    </TableCell>
                                </TableRow>
                            )}
