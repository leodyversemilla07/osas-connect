...
import { AlertTriangle, BookOpen, CheckCircle, Clock, DollarSign, Eye, FileText, Users } from 'lucide-react';
...
export default function ScholarshipsIndex({ scholarships }: ScholarshipsIndexProps) {
    ...
    const shouldShowBeneficiaries = (scholarship: Scholarship) => {
        ...
        return count !== undefined && count !== null && count !== '' && !isNaN(Number(count)) && Number(count) > 0;
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col space-y-4 p-4 sm:space-y-6 sm:p-6 lg:space-y-8 lg:p-8">
                ...
                <div className="border-b pb-6 lg:pb-8">
                    <div>
                        <h1 className="text-foreground text-2xl font-semibold sm:text-3xl lg:text-4xl">Browse Scholarships</h1>
                ...
                {scholarships.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-16 lg:py-24">
                        <FileText className="text-muted-foreground mb-4 h-12 w-12 lg:mb-6 lg:h-16 lg:w-16" />
                        <h3 className="text-foreground mb-3 text-lg font-medium lg:mb-4 lg:text-xl">No scholarships available</h3>
                        <p className="text-muted-foreground max-w-md text-center lg:text-lg">
                    ...
                    <div className="grid gap-6 sm:gap-8 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
                        {scholarships.map((scholarship) => {
                            ...
                            return (
                                <Card key={scholarship.id} className="flex h-full flex-col">
                                    <CardHeader>
                                        <CardTitle className="text-lg leading-tight lg:text-xl">{scholarship.name}</CardTitle>
                                        <CardDescription>
                                        ...
                                        <CardAction>
                                            <Link
                                                ...
                                                className="text-muted-foreground hover:text-primary focus:ring-primary/50 inline-flex items-center justify-center rounded-md p-2 focus:ring-2 focus:outline-none"
                                    ...
                                    <CardContent className="flex flex-1 flex-col justify-between space-y-4 pt-0 lg:space-y-6">
                                        {/* Description */}
                                        <CardDescription className="mb-2 text-sm leading-relaxed lg:text-base">
                                        ...
                                        <div className="space-y-3 lg:space-y-4">
                                            <div className="flex items-center gap-3 text-sm lg:text-base">
                                                <DollarSign className="text-chart-2 h-4 w-4 flex-shrink-0 lg:h-5 lg:w-5" />
                                            ...
                                            {(scholarship.slots_available || scholarship.availableSlots || scholarship.slots) && (
                                                <div className="flex items-center gap-3 text-sm lg:text-base">
                                                    <Users className="text-chart-3 h-4 w-4 flex-shrink-0 lg:h-5 lg:w-5" />
                                                    <span>
                                            ...
                                            {shouldShowBeneficiaries(scholarship) && (
                                                <div className="flex items-center gap-3 text-sm lg:text-base">
                                                    <Users className="text-chart-4 h-4 w-4 flex-shrink-0 lg:h-5 lg:w-5" />
                                                    <span>
                                            ...
                                            {scholarship.gwaRequirement && (
                                                <div className="flex items-center gap-3 text-sm lg:text-base">
                                                    <BookOpen className="text-primary h-4 w-4 flex-shrink-0 lg:h-5 lg:w-5" />
                                                    <span>
                                            ...
                                            {scholarship.stipend_schedule && (
                                                <div className="flex items-center gap-3 text-sm lg:text-base">
                                                    <Clock className="text-chart-5 h-4 w-4 flex-shrink-0 lg:h-5 lg:w-5" />
                                                    <span>
                                        ...
                                        {((scholarship.requirements && scholarship.requirements.length > 0) ||
                                            ...
                                            <div className="space-y-3 lg:space-y-4">
                                                <div className="flex items-center gap-3">
                                                    <BookOpen className="text-primary h-4 w-4 lg:h-5 lg:w-5" />
                                                ...
                                                <div className="ml-7 space-y-2 lg:ml-8">
                                                    {(scholarship.requirements || scholarship.criteria || []).map((requirement, index) => (
                                                        <div key={index} className="text-muted-foreground flex items-start gap-2 text-xs lg:text-sm">
                                                            <span className="text-primary mt-0.5 font-bold lg:mt-1">•</span>
                                        ...
                                        {((scholarship.eligibilityCriteria && scholarship.eligibilityCriteria.length > 0) ||
                                            ...
                                            <div className="space-y-3 lg:space-y-4">
                                                <div className="flex items-center gap-3">
                                                    <Users className="text-chart-4 h-4 w-4 lg:h-5 lg:w-5" />
                                                    <span className="text-sm font-medium lg:text-base">Eligibility:</span>
                                                </div>
                                                <div className="ml-7 space-y-2 lg:ml-8">
                                                    {(scholarship.eligibilityCriteria || scholarship.eligibility_criteria || []).map(
                                                        (criteria: string, index: number) => (
                                                            <div
                                                                key={index}
                                                                className="text-muted-foreground flex items-start gap-2 text-xs lg:text-sm"
                                                            >
                                                                <span className="text-chart-4 mt-0.5 font-bold lg:mt-1">•</span>
                                        ...
                                        {((scholarship.requiredDocuments && Object.keys(scholarship.requiredDocuments).length > 0) ||
                                            ...
                                            <div className="space-y-3 lg:space-y-4">
                                                <div className="flex items-center gap-3">
                                                    <FileText className="text-chart-1 h-4 w-4 lg:h-5 lg:w-5" />
                                                    ...
                                                    {(() => {
                                                        ...
                                                        return documents.map((document, index) => (
                                                            <div
                                                                ...
                                                                className="text-muted-foreground flex items-start gap-2 text-xs lg:text-sm"
                                                            >
                                                                <span className="text-chart-1 mt-0.5 font-bold lg:mt-1">•</span>
                                        ...
                                        <CardFooter>
                                            {scholarship.has_applied ? (
                                                <Button variant="outline" className="min-h-[44px] w-full px-4 lg:min-h-[48px] lg:px-6" disabled>
                                                ...
                                                <Button asChild className="min-h-[44px] w-full px-4 lg:min-h-[48px] lg:px-6">
                                                    <Link href={`/student/scholarships/${scholarship.id}/apply`}>Apply Now</Link>
                                                </Button>
                                            )}
                                        </CardFooter>
                                    </CardContent>
