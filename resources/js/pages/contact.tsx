                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <section className="mt-16 py-16">
                            <div className="text-center mb-12">
                                <div className="inline-flex items-center gap-2 bg-[#23b14d]/20 dark:bg-[#23b14d]/30 px-4 py-2 rounded-full mb-4">
                            ...
                            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                                {pageContent.contacts.map((contact, index) => {
                                    ...
                                    const ContactValue = ({ contact }: { contact: typeof pageContent.contacts[0] }) => {
                                        if (contact.link) {
                                            return (
                                                <a
                                                    href={contact.link}
                                                    className="inline-flex items-center text-base text-[#23b14d] hover:text-[#1a8f3c] transition-colors duration-200 break-all"
                                                >
                                                    {contact.value}
                                                </a>
                                            );
                                    ...
                                    return (
                                        <div key={index} className="group p-8 border border-[#010002]/10 dark:border-[#f3f2f2]/10 rounded-lg">
